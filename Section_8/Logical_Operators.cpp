...
int main (){
    ...
    //assume lower < upper
        ...
        */
    //Determine if an entered integer is exaclty on the boundary
    //assume lower < upper
        /*
        cout << "\nEnter an integer - the bounds are " << lower << " and " << upper << " : ";
        cin >> num;
    ...
    wear_coat = (temperature < temperature_for_coat || winds_speed > wind_speed_for_coat);
    ...
    wear_coat = (temperature < temperature_for_coat && winds_speed > wind_speed_for_coat);
    cout << "Do you need to war a coat using AND?" << wear_coat << endl;
